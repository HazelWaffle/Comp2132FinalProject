...
gameInfo.addEventListener("click", function()
    {
        ...
        $popupline2.text("Today is a nice sunny day, but between you and your favourite sunbeam stands the horrible Hazel. Out-roll the beastie to reclaim your spot! Rules : Two dice are rolled, and their sums are added provided neither shows a 1. If two dice show the same value, multiply their sum by 2!");
        reset1.style.visibility = "hidden";
        closed1.innerText = "Closed";
        $popup.css("background-color", "black"); 
        $show.toggle("show");
        $popup.prop("display", "block");
    }
